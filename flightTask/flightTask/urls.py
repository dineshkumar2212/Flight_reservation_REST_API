...
urlpatterns = [
    ...
    path('flightTask/',include(router.urls)),
    path('api-token-auth/',obtain_auth_token,name='obtain_auth_token'),
    # path('flightTask/findFlights/',views.findflights),
    # path('flightTask/saveReservation/',views.save_reservation)
]
